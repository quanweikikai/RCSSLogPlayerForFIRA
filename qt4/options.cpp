...
const double Options::PITCH_LENGTH = 220.0;
const double Options::PITCH_WIDTH = 180.0;
...
const double Options::CENTER_CIRCLE_R = 25.0;
const double Options::PENALTY_AREA_LENGTH = 35.0;
const double Options::PENALTY_AREA_WIDTH = 80.0;
const double Options::PENALTY_CIRCLE_R = 12.5;
const double Options::PENALTY_SPOT_DIST = 37.5;
const double Options::GOAL_WIDTH = 40;
const double Options::GOAL_HALF_WIDTH = Options::GOAL_WIDTH * 0.5;
const double Options::GOAL_AREA_LENGTH = 35.0;
const double Options::GOAL_AREA_WIDTH = 50.0;
const double Options::GOAL_DEPTH = 5.00;
const double Options::CORNER_ARC_R = 7.0;
